...
struct	cmd_type	cmd_table	[] =
{
    ...
    { "spew",     do_spew, POS_SLEEPING,   3,  LOG_NORMAL   },
    ...
    { "clans",    do_clans, POS_DEAD, 0, LOG_NORMAL },
	 { "make",		do_make,	POS_STANDING, 50, LOG_ALWAYS },
	 { "induct",		do_induct,	POS_STANDING, 50, LOG_ALWAYS },
	 { "outcast",	do_outcast,	POS_STANDING, 50, LOG_ALWAYS  },
	 ...
	 { "balzhur",    do_balzhur,   POS_DEAD,    L_GOD,  LOG_NORMAL },
	 { "ban",		  do_ban,		 POS_DEAD,    L_GOD,  LOG_ALWAYS	},
	 { "for",		  do_for,		 POS_DEAD,    L_GOD,  LOG_ALWAYS	},
	 { "makeclan",	  do_makeclan,	 POS_DEAD,    L_GOD,  LOG_ALWAYS },
	 { "setclan",	  do_setclan,	 POS_DEAD,    L_GOD,  LOG_ALWAYS },
	 { "showclan",	  do_showclan,  POS_DEAD,    L_GOD,  LOG_NORMAL },
/*	 { "opentournament",  do_opentournament, POS_DEAD,    L_GOD,  LOG_ALWAYS	},   */
...
/*	 { "starttournament",	  do_starttournament,  POS_DEAD,    L_GOD,  LOG_ALWAYS	},  */

	 { "aset",		  do_aset,	    POS_DEAD,    L_SUP,  LOG_ALWAYS	},
	 { "cmdtable",	  do_cmdtable,  POS_DEAD,    L_SUP,  LOG_NORMAL	},
	 ...
	 { "force",		  do_force,	    POS_DEAD,    L_SUP,  LOG_ALWAYS	},
	 { "log",		  do_log,		 POS_DEAD,    L_SUP,  LOG_ALWAYS	},
	 { "logcha",     do_logcha,    POS_DEAD,    L_GOD,  LOG_NORMAL },
	 { "pardon",	  do_pardon,	 POS_DEAD,    L_SUP,  LOG_ALWAYS	},
	 { "sla",		  do_sla,		 POS_DEAD,    L_SUP,  LOG_NORMAL	},
	 { "slay",		  do_slay,	    POS_DEAD,    L_SUP,  LOG_ALWAYS	},
	 { "snoop",		  do_snoop,	    POS_DEAD,    L_SUP,  LOG_NORMAL	},
	 { "sset",		  do_sset,	    POS_DEAD,    L_SUP,  LOG_ALWAYS },
	 { "at",		     do_at,		    POS_DEAD,    L_SUP,  LOG_NORMAL	},
	 ...
	 { "memory",	  do_memory,	 POS_DEAD,    L_DEI,  LOG_NORMAL	},
	 ...
	 { "pecho",      do_pecho,     POS_DEAD,    L_DEI,  LOG_NORMAL  },
	 ...
	 { "outfit",	  do_outfit,	 POS_DEAD,    L_ANG,  LOG_NORMAL	},
...
const	struct	social_type	social_table [ ] =
{
	...
	"$n tells $N that $m is addicted to $S love.",
	"$n tells you that $m is addicted to your love.",
	"You stand and admit to all in the room, 'Hi, I'm $n, and I'm a mud addict.'",
	"$n stands and says, 'Hi, I'm $n, and I'm a mud addict.'",
    },
	...
	"$n announces to you, 'I'm going AFK'.",
        "Why tell yourself?  You already know, dumbass!",
	...
	"$n forgets all else as $m air-guitars like Jimi Hendrix."
	 },
    ...
    {
	"bearhug",
        "You give a bearhug to thin air.  You're really weird.",
        "$n bearhugs thin air.  Huh?",
	"You bearhug $M.",
	...
	"You beg the gods for mercy.",
        "Zaknafein bursts out laughing at $n's request for mercy.",
	...
	"Your cheeks are burning.",
        "$n blushes in embarrassment.",
	"You get all flustered up seeing $M.",
	"$n blushes as $m sees $N here.",
	"$n blushes as $m sees you here.  Such an effect on people!",
	"You blush at your own folly.",
	"$n blushes as $m notices $s boo-boo."
    },
	...
	"$n bonks $mself."
	 ...
	 {
	"boogie",
        "You do the Jungle Boogie!",
        "$n gets down and does the Jungle Boogie!!",
...
*/
    {
	"burp",
        "You burp for about thirty seconds.",
        "$n burps impressively.",
	...
	"$n says goodbye to $mself.  Is $m contemplating suicide?"
    },
	...
	"$n is really crazy now!  $m cackles at $mself."
	 },
	...
	"$n coughs loudly.",
	"You cough loudly.  It must be $S fault, $M gave you this cold.",
	...
	"You grin evilly at what you just did.",
	"$n grins evilly at what $m just did."
	 },
	...
	"$n holds $mself in a warm and loving embrace.  $m looks pretty silly."
	 },
	...
	"$n's eyes roll back in $s head and $m crumples to the ground.",
	...
	"$n farts in $N's direction.  Better flee before $m turns to you!",
	...
	"You gasp as you realize what $M did.",
	"$n gasps as $m realizes what $N did.",
	"$n gasps as $m realizes what you did.",
	...
	"$n giggles at $mself.  $m must be nervous or something."
	 },
	...
	"grin",
		  "You grin broadly.",
		  "$n grins broadly.",
		  "You grin broadly at $M.",
		  "$n grins broadly at $N.",
		  "$n grins broadly at you.  You must have said something clever.",
	...
	"grunt",
	"GRNNNHTTTT.",
        "$n grunts like an orc.",
	"GRNNNHTTTT.",
        "$n grunts to $N like an orc!",
        "$n grunts to you like an orc!",
	"GRNNNHTTTT.",
        "$n grunts to $mself like an orc!"
	 },
...

    {
        ...
        "Suddenly, there are 2 $ns standing here!"
    },

    {
	"howl",
	"AHOOOOOOOOOOOOooooooooooooo.",
        "$n howls at the moon.  Creepy.",
	"You howl at $M.",
	...
	"$n says to $mself, 'Voulez-vous couche avec moi ce soir?'"
	 ...
	 {
		  "jsave",
		  "You profess 'Jesus saves!  But Roenick recovers...he scores!'",
		  "$n announces 'Jesus saves!  But Roenick recovers...he scores!'",
		  "You profess 'Jesus saves!  But Roenick recovers...he scores!'",
		  "$n announces 'Jesus saves!  But Roenick recovers...he scores!'",
		  "$n announces to you 'Jesus saves!  But Roenick recovers...he scores!'",
		  "You profess 'Jesus saves!  But Roenick recovers...he scores!'",
		  "$n announces 'Jesus saves!  But Roenick recovers...he scores!'"
	 },
	...
	"You laugh.",
	"$n laughs.",
        "You laugh at $N gleefully.",
        "$n laughs at $N gleefully.",
        "$n laughs at you gleefully.  You must have said something funny!",
	...
	"$n MOSHES insanely about the room.",
        "You slam into $M, starting a mosh pit!  YES!",
        "$n slams into $N.  A mosh pit starts!  Join in!",
	...
	"You nod solemnly.",
	"$n nods solemnly.",
        "You nod to $M in agreement.",
        "$n nods to $N in agreement.",
        "$n nods in agreement to you.",
	...
	"You feel righteous, and maybe a little foolish.",
        "$n begs and grovels to Grishnakh, who laughs mercilessly.",
	...
	"Punch whom?",
	NULL,
        "You punch $M in the nose!  $e must have deserved it.",
        "$n draws back and punches $N in the nose!",
        "$n punches you in the nose.  You must have screwed up.",
	...
	"You grin sheepishly.",
	"$n grins sheepishly.",
	"You grin sheepishly at $M.",
	"$n grins sheepishly at $N, wonder what they are up to.",
	"$n grins sheepeshly at you, uh oh.",
	"You grin sheepishly at what you did",
	"Uh-oh, $n is grinning at $Mself."
	 },
	...
	"$n shivers uncomfortably.",
        "You shiver at $M's remark.",
        "$n shivers at $N's remark.",
        "$n shivers in response to you.",
	...
	"You shrug.",
	"$n shrugs helplessly.",
        "You shrug in response to $M.",
        "$n shrugs in response to $N.",
        "$n shrugs in response to you.",
	...
	"You sigh.",
        "$n sighs bitterly.",
        "You sigh at the sight of $M.",
	"$n sighs at the sight of $N.",
        "$n sighs at you.  What'd you do now?",
	...
	"You raise your clear voice towards the sky.",
        "$n begins to sing 'Nothing Else Matters'.",
    ...
    {
        "snort",
        "You snort explosively.  SNORT!  SNORT!",
        "$n snorts in derision",
        "You snort in derision at $M.",
        "$n snorts at $N.",
        "$n snorts at you.",
        "You snort.",
        "$n snorts to $mself."
    ...
    {
	"whistle",
        "You whistle the latest hit song.",
        "$n whistles 'Jak o' the Shadows'.  Care to join in?",
...
bool check_social( CHAR_DATA *ch, char *command, char *argument )
{
    ...
    if ( arg[0] == '\0' )
    {
        act(AT_CYAN, social_table[cmd].others_no_arg, ch, NULL, victim, TO_ROOM    );
        act(AT_CYAN, social_table[cmd].char_no_arg,   ch, NULL, victim, TO_CHAR    );
	 }
    ...
    {
        act(AT_CYAN, social_table[cmd].others_auto,   ch, NULL, victim, TO_ROOM    );
        act(AT_CYAN, social_table[cmd].char_auto,     ch, NULL, victim, TO_CHAR    );
    }
    else
	 {
        act(AT_CYAN, social_table[cmd].others_found,  ch, NULL, victim, TO_NOTVICT );
        act(AT_CYAN, social_table[cmd].char_found,    ch, NULL, victim, TO_CHAR    );
        act(AT_CYAN, social_table[cmd].vict_found,    ch, NULL, victim, TO_VICT    );
	...
	&&   IS_AWAKE(victim) )
	{
		...
		break;
		 ...
		 case 5: case 6: case 7: case 8:
                act(AT_CYAN, social_table[cmd].others_found,
			 victim, NULL, ch, TO_NOTVICT );
                act(AT_CYAN, social_table[cmd].char_found,
			 victim, NULL, ch, TO_CHAR    );
                act(AT_CYAN, social_table[cmd].vict_found,
			 victim, NULL, ch, TO_VICT    );
		break;

		 case 9: case 10: case 11: case 12:
                act(AT_CYAN, "$n slaps $N.",  victim, NULL, ch, TO_NOTVICT );
                act(AT_CYAN, "You slap $N.",  victim, NULL, ch, TO_CHAR    );
                act(AT_CYAN, "$n slaps you.", victim, NULL, ch, TO_VICT    );
		break;
		 }
	}
	 }
