...
void do_hunt( CHAR_DATA *ch, char *argument )
{
  ...
  if( ch->in_room == victim->in_room )
    {
      act(AT_BLUE, "$N is here!", ch, NULL, victim, TO_CHAR );
      return;
    }
  ...
  act(AT_BLUE, "$n carefully sniffs the air.", ch, NULL, NULL, TO_ROOM );
  ...
  if( direction == -1 )
    {
      act(AT_BLUE, "You couldn't find a path to $N from here.",
...
void hunt_victim( CHAR_DATA *ch )
{
  ...
  if( ch->in_room == ch->hunting->in_room )
    {
      act(AT_BLUE, "$n glares at $N and says, 'Ye shall DIE!'",
	  ch, NULL, ch->hunting, TO_NOTVICT );
      act(AT_BLUE, "$n glares at you and says, 'Ye shall DIE!'",
	  ch, NULL, ch->hunting, TO_VICT );
      act(AT_BLUE, "You glare at $N and say, 'Ye shall DIE!",
  ...
  if( dir < 0 || dir > 5 )
    {
		act(AT_BLUE, "$n says 'Damn!  Lost $M!'", ch, NULL, ch->hunting, TO_ROOM );
      ch->hunting = NULL;
      return;
    }
